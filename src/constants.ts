...
export const CHAPTERS: Chapter[] = [
  {
    ...
    cartoonPanels: [
      { id: 1, image: '/assets/images/Cartoon_Original1.png', caption: 'Ralph lived a simple life, untroubled by the world beyond his pack.', alt: 'Ralph walking with the caravan under the warm desert sun.' },
  ...
  },
  {
    ...
    cartoonPanels: [
      ...
      { id: 13, image: '/assets/images/Cartoon_Original13.png', caption: 'Where the world’s heart touched the sky, the gate waited.', alt: 'A vast arch of molten glass rises from the sand, pulsing with light.' },
      { id: 14, image: '/assets/images/Cartoon_Original14.png', caption: 'Ralph: "If this is the dream… then I’ll walk it." New: "Then walk true."', alt: 'Ralph steps forward, New hovering beside him.' },
      { id: 15, image: '/assets/images/Cartoon_Original15.png', caption: 'Beyond the gate, the world burned bright - and breathed.', alt: 'They emerge into a vast valley of floating lights, crystalline flora, and rivers of molten gold.' }
    ]
  },
  {
    id: 4,
    ...
    cartoonPanels: [
      { id: 401, image: 'https://placehold.co/600x400/1a1a1a/f59e0b?text=Coming+Soon', caption: 'To be Continued', alt: 'To be Continued' }
    ]
  },
  {
    id: 5,
    ...
    cartoonPanels: [
      { id: 501, image: 'https://placehold.co/600x400/1a1a1a/ef4444?text=The+Shadow+Of+Malakar', caption: 'A darkness fell over the dunes that no ordinary sun could pierce.', alt: 'Malakar appearing' },
      { id: 502, image: 'https://placehold.co/600x400/1a1a1a/f59e0b?text=More+Panels+Coming+Soon', caption: 'The final confrontation is being prepared...', alt: 'Coming soon' }
    ]
  },
  {
    id: 6,
